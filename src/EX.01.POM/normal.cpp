...
void NormalMappingRenderer::initialize()
{
    shader_.initializeStageFromFile<VS>(
        "./asset/EX.01/normal.hlsl", nullptr, "VSMain");
    shader_.initializeStageFromFile<PS>(
        "./asset/EX.01/normal.hlsl", nullptr, "PSMain");
...
void NormalMappingRenderer::setCamera(const Mat4 &viewProj)
{
    viewProj_ = viewProj;
}

void NormalMappingRenderer::setLight(const DirectionalLight &light)
{
    psLightData_.light = light;
}

void NormalMappingRenderer::setDiffStep(int step)
{
    psLightData_.diffStep = static_cast<float>(step);
}

void NormalMappingRenderer::begin()
{
...
void NormalMappingRenderer::end()
{
...
void NormalMappingRenderer::render(const Mesh &mesh)
{
