...
void VarianceShadowMapRenderer::initialize(const Int2 &resolution)
{
    // shader

    shader_.initializeStageFromFile<VS>("./asset/00/vsm_sm.hlsl", nullptr, "VSMain");
    shader_.initializeStageFromFile<PS>("./asset/00/vsm_sm.hlsl", nullptr, "PSMain");
...
ComPtr<ID3D11ShaderResourceView> VarianceShadowMapRenderer::getSRV() const
{
    return renderTarget_.getColorShaderResourceView(0);
}

const Mat4 &VarianceShadowMapRenderer::getLightViewProj() const
{
    return lightViewProj_;
}

void VarianceShadowMapRenderer::setLight(const Light &light)
{
    light_ = light;
    updateLightViewProj();
}

void VarianceShadowMapRenderer::begin()
{
...
void VarianceShadowMapRenderer::end()
{
...
void VarianceShadowMapRenderer::updateLightViewProj()
{
    Float3 up;
...
void MeshRendererVSM::initialize()
{
    // shader

    shader_.initializeStageFromFile<VS>("./asset/00/vsm_mesh.hlsl", nullptr, "VSMain");
    shader_.initializeStageFromFile<PS>("./asset/00/vsm_mesh.hlsl", nullptr, "PSMain");
...
void MeshRendererVSM::setCamera(const Mat4 &viewProj)
{
    viewProj_ = viewProj;
}

void MeshRendererVSM::setLight(const Light &light)
{
    psLight_.update(light);
}

void MeshRendererVSM::setShadowMap(
